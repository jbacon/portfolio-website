...
const blog = () => (
  <>
    ...
    <Typography variant="h5">
      The Fall of Server-Side Rendering (SSR)
    </Typography>
    <Typography>
      Everything changed when browsers advanced... <br />
      JavaScript now allows browsers to make asynchronous calls to servers,
      without ever refreshing the full page. With SSR a browser will often
    ...
    <Typography>
      Static pages make the return to center stage! JavaScript and HTML together
      are now capable of rendering dynamic content within the browser. Server
      software is back in action (hello nginx), and SSR frameworks are pushed
      aside. Client-Side Rendering (CSR) enables the evolution of server APIs
      (Application Programming Interfaces). Server APIs can focus on delivering
      just data (i.e. JSON) to clients instead of rending HTML. Web pages can
      now integrate with multiple API Servers to be served data from various
      sources, all while rendering content dynamically. See{" "}
      <Link
    ...
    <Typography>
      Browsers are doing some heavy lifting running all this JavaScript. Are you
      noticing long load times, slow web pages, and unresponsive interfaces? I
      sure am. Is JavaScript to blame? Since off-loading heavy rendering
      responsibilities, servers have shifted the strain to client frameworks.
      Will optimizations be enough? Or will the power of the Cloud give SSR the
      strength to return?
      <br />
      ...
      <Link
        ...
        to="/blog/2015/MultiPageVsSinglePageApplications"
      >
